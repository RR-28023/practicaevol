...
![Entrada 1. Horarios clases del mejor individuo primera iteración.](imagenes/entrada1_plot_inicial_clases.png){width=85%}

![Entrada 1. Horarios clases del individuo solución.](imagenes/entrada1_plot_final_clases.png){width=85%}
...
-**Modificación 1**: Selección totalmente aleatoria donde no se tiene en cuenta el valor de fitness. Es importante destacar que esto no elimina completamente la convergencia hacia una solución con mejor fitness, porque también está la selección de padres, que sigue estando sesgada hacia los individuos con mejor fitness.
...
Se puede observar como la modificación 2 sigue siendo la que mejor resultados dá. Aunque en este caso la modificación 3 también supera al algorimto original.
