...
author: "Joan Pons y Ramon Rotaeche"
date: "28/12/2020"
output: pdf_document
---
...
* *Disponibilidad_Profesor_Franja~pxt~*, abreviado como **DPF~pxt~**, es una matriz donde el elemento *ij* representa la disponibilidad del profesor *i* en la franja *j*. Vale 1 si el profesor puee dar clase a esa hora o 0 si no puede.
