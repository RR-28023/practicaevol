...
Para representar cada posible solución usaremos la matriz **Genotipo~mxt~**, donde el elemento *ij* representa la asignatura asignada a la clase *i* en la franja *j*.
...
### 2.3 Inicialización de los individuos
